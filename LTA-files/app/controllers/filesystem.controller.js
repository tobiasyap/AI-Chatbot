...
exports.create = (req, res) => {
    ...
    try {
      console.log('python', process.cwd() + '/nlp-model/add_file.py')
      const python1 = spawn('python', process.cwd() + '/nlp-model/add_file.py')
      // const python1 = spawn('python', [process.cwd() + '/nlp-model/add_file.py', req.file.filename])
    ...
    //   const python2 = spawn('python', [process.cwd() + "/nlp-model/update_tfidf_corpus.py"])
