...
const AddFile = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(`${backendUrl}/api/filesystem/files`, uploadData)
      .then((success) => {
        setSubmitted(true);
      })
      .catch((error) => {
